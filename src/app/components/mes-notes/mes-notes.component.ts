...
import { FormArray, FormBuilder, NgForm, FormGroup, FormControl, Validators } from '@angular/forms';
import { Critere } from 'src/app/models/critere';
import { Fonctionnaire } from 'src/app/models/fonctionnaire';
import { CritereNote, Note, NoteParCritere } from 'src/app/models/note';
