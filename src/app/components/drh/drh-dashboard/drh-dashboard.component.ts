...
@Component({
    selector: 'app-drh-dashboard',
    templateUrl: './drh-dashboard.component.html',
    styleUrls: ['./drh-dashboard.component.css']
})
export class DrhDashboardComponent implements OnInit {
